...
larray = [sleap.model.topdown.internal.Postprocess1CustomLayer('Name', 'postprocesscentroidmodel', ...
    ...
    larrayTd(2:end-1); ...
    sleap.model.topdown.internal.Postprocess2CustomLayer('Name', 'postprocesstopdownmodel', ...
